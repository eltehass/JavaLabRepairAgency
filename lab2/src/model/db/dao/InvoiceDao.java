...
public class InvoiceDao extends AbstractDao<Invoice, Integer> {
    ...
    public List<Invoice> getAll() throws SQLException {
        var preparedStatement = getPrepareStatement("SELECT * FROM invoices");
    ...
    public List<Invoice> getNotDoneForMaster(Integer masterId) throws SQLException {
        var preparedStatement = getPrepareStatement("SELECT * FROM invoices WHERE is_done = 0 AND id_master = ?");
        var result = new ArrayList<Invoice>();
    ...
    public List<Invoice> getFinishedForCustomer(Integer personId) throws SQLException {
        var preparedStatement = getPrepareStatement("SELECT * FROM invoices WHERE is_done = 1 AND (id_application in (SELECT id FROM applications WHERE id_person_info = ?))");
        var result = new ArrayList<Invoice>();
...
//    }
    ...
    public Invoice getEntityById(Integer id) throws SQLException {
        var preparedStatement = getPrepareStatement("SELECT * FROM invoices WHERE id = ?");
